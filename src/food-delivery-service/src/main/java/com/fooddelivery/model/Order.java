 ...
 * Date: April 4, 2026
 * Description: Order entity representing a customer's food order
 */
...
/**
 * Order entity mapped to "orders" MongoDB collection.
 * Represents a customer's order with items, delivery details, and status tracking.
 */
